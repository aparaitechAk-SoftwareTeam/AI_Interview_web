  ...
  return <View style={styles.root}>
    ...
    <SafeAreaView style={{ flex: 1 }} edges={["top", "bottom"]}>
      <ScrollView contentInsetAdjustmentBehavior="automatic" contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Pressable accessibilityRole="button" accessibilityLabel="Open Bulk Smart Import" onPress={() => router.push("/admin-bulk-candidates")} style={({ pressed }) => ({ borderRadius: 17, borderWidth: 1, borderColor: "rgba(81, 217, 153, 0.4)", backgroundColor: "rgba(25, 100, 105, 0.3)", paddingHorizontal: 15, paddingVertical: 14, flexDirection: "row", alignItems: "center", justifyContent: "space-between", opacity: pressed ? 0.78 : 1 })}><View style={{ flex: 1, paddingRight: 12 }}><Text selectable style={{ color: "#ECFFF8", fontWeight: "900", fontSize: 15 }}>Bulk Smart Import</Text><Text selectable style={{ color: "#B4DDD4", fontSize: 12, marginTop: 3 }}>Scan Excel, PDF, Word or images and prepare candidate invitations</Text></View><Text style={{ color: "#7BE8C1", fontSize: 20 }}>›</Text></Pressable>
